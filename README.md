...
JGLOOm is a Java library for wrapping OpenGL objects in object-oriented containers.  
It aims to contain the full functionality of OpenGL for all versions, accross all 
...
same!  Both a LWJGL and JOGL texture use the same process for texture loading.
...
for OpenGL objects.  This means that objects can be more easily tracked and managed.  
It also means that multiple OpenGL APIs can be unified to be interchangeable.