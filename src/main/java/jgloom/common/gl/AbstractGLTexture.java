...
public abstract class AbstractGLTexture implements GLTexture {
     ...
     */
    public abstract void setParameter(int target, int param, float parameter);
    /** Int version of {@link #setParameter(int, int, float)} */
    public abstract void setParameter(int target, int param, int parameter);
    /** Float buffer version of {@link #setParameter(int, int, float)} */
    public abstract void setParameter(int target, int param, FloatBuffer parameter);
    /** Int buffer version of {@link #setParameter(int, int, float)} */
    public abstract void setParameter(int target, int param, IntBuffer parameter);
     ...
     */
    public abstract void image1D(int target, int level, int internalformat, int width, int border, int format, int type, ByteBuffer pixels);
    /** Buffer object offset version of: {@link #image1D(int, int, int, int, int, int, int, ByteBuffer)} */
    public abstract void image1D(int target, int level, int internalformat, int width, int border, int format, int type, long pixelsOffset);
    /** ShortBuffer version of: {@link #image1D(int, int, int, int, int, int, int, ByteBuffer)} */
    public abstract void image1D(int target, int level, int internalformat, int width, int border, int format, int type, ShortBuffer pixels);
    /** IntBuffer version of: {@link #image1D(int, int, int, int, int, int, int, ByteBuffer)} */
    public abstract void image1D(int target, int level, int internalformat, int width, int border, int format, int type, IntBuffer pixels);
    /** FloatBuffer version of: {@link #image1D(int, int, int, int, int, int, int, ByteBuffer)} */
    public abstract void image1D(int target, int level, int internalformat, int width, int border, int format, int type, FloatBuffer pixels);
    /** DoubleBuffer version of: {@link #image1D(int, int, int, int, int, int, int, ByteBuffer)} */
    public abstract void image1D(int target, int level, int internalformat, int width, int border, int format, int type, DoubleBuffer pixels);
     ...
     * @param pixels         the texel data
     */
    public abstract void image2D(int target, int level, int internalformat, int width, int height, int border, int format, int type, ByteBuffer pixels);
    /** Buffer object offset version of: {@link #image2D(int, int, int, int, int, int, int, int, ByteBuffer)} */
    public abstract void image2D(int target, int level, int internalformat, int width, int height, int border, int format, int type, long pixelsOffset);
    /** ShortBuffer version of: {@link #image2D(int, int, int, int, int, int, int, int, ByteBuffer)} */
    public abstract void image2D(int target, int level, int internalformat, int width, int height, int border, int format, int type, ShortBuffer pixels);
    /** IntBuffer version of: {@link #image2D(int, int, int, int, int, int, int, int, ByteBuffer)} */
    public abstract void image2D(int target, int level, int internalformat, int width, int height, int border, int format, int type, IntBuffer pixels);
    /** FloatBuffer version of: {@link #image2D(int, int, int, int, int, int, int, int, ByteBuffer)} */
    public abstract void image2D(int target, int level, int internalformat, int width, int height, int border, int format, int type, FloatBuffer pixels);
    /** DoubleBuffer version of: {@link #image2D(int, int, int, int, int, int, int, int, ByteBuffer)} */
    public abstract void image2D(int target, int level, int internalformat, int width, int height, int border, int format, int type, DoubleBuffer pixels);
